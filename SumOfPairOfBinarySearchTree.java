package sumOf_pairOf_binarySearch_tree;
...
public class SumOfPairOfBinarySearchTree {
	
	Node root;
	
	SumOfPairOfBinarySearchTree() 
	{ 
		root = null; 
	}
    ...
    {
        SumOfPairOfBinarySearchTree BStree = new SumOfPairOfBinarySearchTree();
